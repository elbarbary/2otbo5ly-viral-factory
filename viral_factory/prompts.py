...
{{
  ...
  "shots": [
    {{
      ...
      "shot_image_prompt_en": "string — a visually STUNNING still-frame image prompt for the FIRST FRAME of this shot. Include: all character visual locks, dramatic lighting (golden hour, neon, warm kitchen glow), strong color palette, depth of field. Make it scroll-stopping beautiful. Each shot must have a DIFFERENT camera angle and setting from the others.",
  ...
  "video_plan": {{
    ...
    "shots": [
      {{
        ...
        "purpose": "string",
        "continuity_lock": "string",
        "shot_image_prompt_en": "string — visually STUNNING still-frame image prompt for the FIRST FRAME. Dramatic lighting, strong colors, depth of field, all character visual locks. Different camera angle and setting from other shots.",
        "veo_prompt_en": "string",
        "negative_prompt_en": "string",
        "overlay_text_ar": "string",
